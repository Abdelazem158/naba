...
Route::group([
    ...
    Route::group([ 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'admin' ],function(){
        ...
        Route::group(['middleware' => 'adminLogin'],function(){
            ...
            Route::get('admins/toggle-moderator/{id}', 'AdminController@toggle_moderator')->name('admins/toggle-moderator');
            ...
            Route::post('data/admins/info-update/{id}', 'AdminController@data_info_update')->name('admin/data/admins/info-update');
            Route::post('data/admins/change-password/{id}', 'AdminController@data_change_password')->name('admin/data/admins/change-password');
            ...
            Route::get('contact-us/export/excel', 'ContactUsController@export_excel')->name('admin/contact-us/export/excel');

            // about-us routes
            Route::get('about-us/index', 'AboutUsController@index')->name('admin/about-us/index');
            Route::get('about-us/create', 'AboutUsController@create')->name('admin/about-us/create');
            Route::post('about-us/create', 'AboutUsController@store')->name('admin/about-us/store');
            Route::get('about-us/edit/{id?}', 'AboutUsController@edit')->name('admin/about-us/edit');
            Route::post('about-us/edit/{id}', 'AboutUsController@update')->name('admin/about-us/update');
            Route::get('about-us/activate', 'AboutUsController@activate')->name('admin/about-us/activate');
            Route::get('about-us/delete', 'AboutUsController@delete')->name('admin/about-us/delete');
            Route::post('about-us/getMore', 'AboutUsController@getMore')->name('admin/about-us/getMore');
            Route::post('about-us/search', 'AboutUsController@search')->name('admin/about-us/search');
