...
class AdminRepository extends AbstractRepository
{
    ...
    public function toggle_moderator($id)
    {
        try{
            ...
            if(!$current_admin || $current_admin->main_admin === 0){
                flash()->error("There IS Somrthing Wrong");
                return back();
            }

            // check if admin has accesss
            ...
            // updaet information
            $admin->main_admin = $admin->main_admin == 0 ? 1 : 0 ;
            $admin->save();
            flash()->success("Success");
            return back();
        }catch(\Exception $ex){
    ...
    public function DataAdminUpdateInfo($id, $request)
    {
        try{
            // get admin
            $admin = $this->model->find($id);
    ...
    public function DataAdminChangePassword($id, $request)
    {
        try{
            // validation
            // get admin
