...
class ContactUsController extends Controller
{
    public function contact_us(Request $request)
    {
        try{
            ...
            $contact->save();
            //////////////////////////////////////// send email
            Mail::to("Ali@nabasoft.com")->cc("tarek@nabasoft.com")->bcc("info@nabasoft.com")->send(New Contact($contact)); // send email 
            // Mail::to("amrhuusien99@gmail.com")->cc("eng.mohamedahmed59@gmail.com")->bcc("naelmahdy22@gmail.com")->send(New Contact($contact)); // send email 
