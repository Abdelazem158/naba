...
class AdminController extends Controller
{
    ...
    public function toggle_moderator($id) {
        return $this->admin->toggle_moderator($id);
    }
    ...
    public function edit($id){
        return $this->admin->AdminEdit($id);
    }

    public function data_info_update($id, Request $request){
        return $this->admin->DataAdminUpdateInfo($id, $request);
    }

    public function data_change_password($id, AdminChangePasswordRequest $request){
        return $this->admin->DataAdminChangePassword($id, $request);
    }
