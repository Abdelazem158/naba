            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{route('admin/products/section/index', $product_section->product_id)}}">Options</a>
                    </li>
                    @endisset
    ...
    <div class="col-lg-12">
        ...
        <div class="panel tabbed-panel panel-info">
            ...
            <div class="panel-body">
                @isset($product_section)
                <form role="form" action="{{url(route('admin/products/section/update', $product_section->id))}}"
                        ...
                        <div>
                            <div class="form-group input-group">
                                ...
                                <input name="title_ar" type="text" class="form-control" placeholder="Title AR"
                                    value="{{ $product_section->translate('ar')->title }}">
                                @error('title_ar')
                            ...
                            <div class="form-group input-group">
                                ...
                                <input name="description_ar" type="text" class="form-control"
                                    ...
                                    value="{{ $product_section->translate('ar')->description }}">
                            ...
                            <div class="form-group input-group">
                                ...
                                <select class="form-control" name="section_no" id="section_no">
                                    ...
                                    <option value="1"
                                        <?php if( (int)$product_section->section_no == 1 ){ echo "selected"; } ?>>
                                        Section ONE</option>
                                    <option value="2"
                                        <?php if( (int)$product_section->section_no == 2 ){ echo "selected"; } ?>>
                                        Section TWO</option>
                                </select>
                                @error('section_no')
                                <span class="text-danger">{{$message}}</span>
                        ...
                        <div>
                            <div class="form-group input-group">
                                ...
                                <input name="title_en" type="text" class="form-control" placeholder="Title EN"
                                    value="{{ optional($product_section->translate('en'))->title }}">
                                @error('title_en')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group input-group" id="description_item">
                                ...
                                <input name="description_en" type="text" class="form-control"
                                    ...
                                    value="{{ optional($product_section->translate('en'))->description }}">
