                    ...
                    <form role="form" action="{{url(route('admin/products/create'))}}" method="post" enctype="multipart/form-data">
                        <div class="tab-content">
                            ...
                            <div>
                                ...
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="color: red;">*</span>
                                    <input name="color_title" type="color" id="favcolor" class="form-control" placeholder="Title Color" value="{{ old('color_title') }}">
                                    @error('color_title')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="color: red;">*</span>
                                    <input name="backgrounnd_link" type="text" class="form-control" placeholder="backgrounnd Link" value="{{ old('backgrounnd_link') }}">
