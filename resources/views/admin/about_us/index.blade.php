            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        <div id="dataTables-example_filter" class="dataTables_filter">
                            <label><input id="data_search" placeholder="search" type="search"
                ...
                <div class="dataTable_wrapper">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody id="tableShowData">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <?php
                                                if($about->section == 1){ $section = "Excellence points"; }
                                                elseif($about->section == 2){ $section = "Why Naba"; }
                                                elseif($about->section == 3){ $section = "Our clients"; }
                                                elseif($about->section == 4){ $section = "Our techniques"; }
                                                elseif($about->section == 5){ $section = "Our vision"; }
                                            ?>
                                <td>{{ $section }}</td>
                                <?php
                    ...
                    <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                        Showing 1 to <span id="showItems"></span> of <span>{{App\Models\AboutUs::count()}}</span>
                        entries
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form role="form" action="{{url(route('admin/about-us/delete'))}}" method="get">
                                    {{ csrf_field() }}
                ...
                <div class="modal fade" id="myModalActivation" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form role="form" action="{{url(route('admin/about-us/activate'))}}" method="get">
                                    {{ csrf_field() }}
                                    <p>Are You Sure To Update This Record ?</p>
...
$(document).ready(function() {
    $(document).on('click', '#load_more_button', function() {
        ...
        function load_data(id = "", _token) {
            $.ajax({
                url: "{{ route('admin/about-us/getMore') }}",
                method: "POST",
                data: {
                    id: id,
                    _token: _token,
                ...
                success: function(data) {
                    if (data.length > 0) {
                        for (let i = 0; i < data.length; i++) {
                            ...
                            edit_route = "{{ route('admin/about-us/edit') }}" + '/' + data[
                                i].id;
                            if (data[i].section == 1) {
                                section = "Excellence points";
                        ...
                        let btnData =
                            `<button type="button" name="load_more_button" style="width: 350px;" class="btn btn-info form-control px-5" data-id=${length} id="load_more_button">عرض المزيد</button>`
...
$(document).on('keyup', '#data_search', function() {
    ...
    $.ajax({
        url: "{{ route('admin/about-us/search') }}",
        method: "POST",
        data: {
            query: query,
            _token: _token
        ...
        success: function(data) {
            if (data.length > 0) {
                for (let i = 0; i < data.length; i++) {
                    image_path = "{{ asset('') }}" + data[i].image;
                    edit_route = "{{ route('admin/about-us/edit') }}" + '/' + data[i].id;
                    if (data[i].section == 1) {
                        section = "Excellence points";
                    } else if (data[i].section == 2) {
                        section = "Why Naba";
