            ...
            <div class="panel-body">
                ...
                <div class="dataTable_wrapper">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <div class="ml-2 d-flex">
                                        <img src="{{asset($admin->photo)}}" alt="admin image"
                                    ...
                                    <ul class="nav navbar-center navbar-top-links" style="border-radius: 15px;">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-user">
                                                <?php if((int)auth()->guard('admin')->user()->main_admin == 1){ ?>
                                                <li>
                                                ...
                                                <li class="divider"></li>
                                                <?php } ?>
                                                <?php if((int)auth()->guard('admin')->user()->main_admin == 1 && auth()->guard('admin')->user()->id != $admin->id){ ?>
                                                <li>
                                                    <a href="{{route('admins/toggle-moderator', $admin->id)}}"
                                                        style="text-decoration: none; color: white; margin:auto"
                                                        class="btn btn-success">
                                                        {{(int)$admin->main_admin == 1 ? "Make Moderator": "Make Admin"}}
                                                    </a>
                                                </li>
                                                <li class="divider"></li>
                                                <?php } ?>
                    ...
                    <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                        Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Admin::count()}}</span> entries
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form role="form" action="{{url(route('admins/delete'))}}" method="get">
                                    {{ csrf_field() }}
                ...
                <div class="modal fade" id="myModalActivation" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form role="form" action="{{url(route('admins/activate'))}}" method="get">
                                    {{ csrf_field() }}
                                    <p>Are You Sure To Update This Record ?</p>
                        ...
                        for (let i = 0; i < data.length; i++) {
                            ...
                            records += `
                                        <tr>
                                            ...
                                            <td>
                                                <div class="ml-2 d-flex">
                                                    <img src="${data[i].photo}" alt="" class="img-fluid img-50 rounded-circle blur-up lazyloaded" width="100">
                                                </div>
                                            </td>
                                            <td>${data[i].name}</td>
                                            <td>${data[i].email}</td>
