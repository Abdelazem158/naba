    ...
    <section class="blog-area">
        <div class="container">
            <div class="section-title text-center mb-55 wow fadeInUp delay-0-2s">
                <h3><span class="orange-text">Our </span> Trainings</h3>
			...
			@foreach($trainings as $training)
			   <div class="col-xl-4 col-md-6">
                    <div class="blog-item style-two wow fadeInUp delay-0-2s">
                        <div class="image">
                            <img src="{{asset('public/' . $training->image)}}" alt="Blog">
                        </div>
                        <div class="content">
                            <ul class="blog-meta">
                                <li><i class="far fa-calendar-alt"></i> <a href="#">{{$training->date_from}} TO
                                    {{$training->date_to}}</a></li>
        
                            </ul>
                            <h4><a href="blog-details.html"> {{ $training->name }} </a></h4>
                            <p> {{$training->description}} </p>
                            <a href="{{route('front/training', $training->id)}}" class="read-more">Join Now <i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
			@endforeach
